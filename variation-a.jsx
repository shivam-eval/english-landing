// VoiceEval English Coach - your WhatsApp friend for spoken English practice.
// Warm, simple, local. For Hindi/Hinglish learners across India.

const VA_DEFAULTS = /*EDITMODE-BEGIN*/{
  "accentColor": "#9a3412",
  "headline": "VoiceEval English Coach",
  "italicWord": "English",
...
const WA_LINK = 'https://wa.me/916361405165?text=Hi%20VoiceEval%20English%20Coach%21%20I%20want%20to%20practise%20English.';
  ...
  return (
    <nav style={{
      ...
      <a href="#" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', color: 'inherit', minWidth: 0 }}>
        ...
        <div style={{ fontSize: 19, letterSpacing: '-0.01em', fontWeight: 500, whiteSpace: 'nowrap' }}>VoiceEval English Coach</div>
      </a>
...
const VAChatWindow = () => (
  <div style={{
    ...
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        <div style={{ fontSize: 14, fontWeight: 600 }}>VoiceEval English Coach</div>
    ...
    <div style={{
      ...
      <ChatBubble from="bot">
        Namaste! I'm VoiceEval English Coach. Send a voice note in English - about your day, your work, anything. Don't worry about mistakes.
      </ChatBubble>
    ...
    <section id="how-it-works" style={{ padding: `${mobile ? 72 : 96}px ${px}` }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: cols, gap: 2, border: '1px solid rgba(26,22,19,0.12)', background: 'rgba(26,22,19,0.12)' }}>
        {[
          ...
          { n: '02', t: 'Pick a topic', d: 'VoiceEval English Coach suggests a topic - your day, a job interview question, a phone call. Or pick your own.' },
...
const VAFooter = () => {
  ...
  return (
    <footer style={{
      ...
      <div>© 2026 VOICEEVAL ENGLISH COACH</div>
